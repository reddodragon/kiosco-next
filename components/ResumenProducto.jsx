    ...
    return (
        <div className="shadow mb-3 p-5 flex gap-10 items-center">
            ...
            <div>
                <button
                    type="button"
                    className="bg-sky-700 uppercase flex gap-2 px-5 py-2 text-white rounded-full font-bold shadow-md w-full "
                ...
                <button
                    type="button"
                    className="bg-red-700 uppercase flex gap-2 justify-center px-5 py-2 text-white rounded-full font-bold shadow-md w-full mt-3"
